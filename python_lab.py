...
three_digits_set = { (x+y*base+z*base*base) for x in digits for y in digits for z in digits }
...
## Task 18
odd_num_list_range = { o+1 for o in range(99) if (o+1)%2==1 }
...
k = 'James'
value_list = [ e[k] for e in dlist]

## Task 22
dlist = [{'Bilbo':'Ian','Frodo':'Elijah'},{'Bilbo':'Martin','Thorin':'Richard'}]
k = 'Bilbo'
value_list_modified_1 = [ e[k] if k in e else 'Not Present' for e in dlist ] # <-- Use the same expression here
k = 'Frodo'
value_list_modified_2 = [ e[k] if k in e else 'Not Present' for e in dlist ] # <-- as you do here
...
listdict2dict = { names[key]:salary for (key,salary) in d.items() }
